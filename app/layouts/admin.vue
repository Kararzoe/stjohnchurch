<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <!-- Mobile overlay -->
    <div v-if="sidebarOpen && isMobile" @click="sidebarOpen = false" class="fixed inset-0 z-40 bg-black/50" />
    ...
    <aside :class="[
      ...
      <div class="flex items-center gap-3 px-4 py-5 border-b border-white/10">
        ...
        <div v-if="sidebarOpen" class="min-w-0 flex-1 flex items-center justify-between">
          <div>
          ...
          <button v-if="isMobile" @click="sidebarOpen = false" class="text-gray-400 hover:text-white ml-2 shrink-0">
      ...
      <div class="p-3 border-t border-white/10">
        <button @click="logout" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-gray-400 hover:bg-red-500/20 hover:text-red-400 transition-all w-full">
    ...
    <!-- Main content -->
    <div :class="['flex flex-col min-h-screen transition-all duration-300', !isMobile && (sidebarOpen ? 'ml-64' : 'ml-16')]">
      <!-- Top bar -->
      <header class="bg-white border-b border-gray-200 px-4 py-4 flex items-center justify-between sticky top-0 z-40">
        ...
        <div class="flex items-center gap-3">
          <span class="text-xs text-gray-400 hidden sm:block">St. John of the Cross · Mararaba</span>
